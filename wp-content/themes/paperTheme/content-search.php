...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-footer">
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', '_paperTheme' ), __( '1 Comment', '_paperTheme' ), __( '% Comments', '_paperTheme' ) ); ?></span>
		<?php endif; ?>

		<?php edit_post_link( __( 'Edit', '_paperTheme' ), '<span class="edit-link">', '</span>' ); ?>
	</footer><!-- .entry-footer -->
</article><!-- #post-## -->